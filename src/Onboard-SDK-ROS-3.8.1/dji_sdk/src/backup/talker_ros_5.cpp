...
int main(int argc, char **argv){
  ...
  cout << "Move forawrd after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,0.1,0.0,0.0,0.0);
  move(cont,0.5);

  cout << "Move back after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,-0.1,0.0,0.0,0.0);
  move(cont,0.5);

  cout << "Move left after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,0.0,0.1,0.0,0.0);
  move(cont,0.5);

  cout << "Move right after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,0.0,-0.1,0.0,0.0);
  move(cont,0.5);

  cout << "Move up after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,0.0,0.0,0.1,0.0);
  move(cont,0.5);

  cout << "Move down after 1s" << endl;
  ros::Duration(1).sleep();
  spd(cont,0.0,0.0,-0.1,0.0);
  move(cont,0.5);
