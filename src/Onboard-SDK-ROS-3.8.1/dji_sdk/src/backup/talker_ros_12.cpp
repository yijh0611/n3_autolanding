...
// talker_ros_12
// 착륙 관련 코드는 없다.
// 태그 보면서 좌우로 등속 이동하는 코드

// 아직 작업 중인 부분
// talker_ros_10의 백업 느낌. 태그 보면서 이동하는거 있음.
// 이거도 등속으로 하긴 하는데, 처음에 속도 몇으로 할지 입력 받게 만들기.
// 컴파일 아직은 안함.
...
int main(int argc, char **argv){
  ...
  is_run_thread = true;
  ros::init(argc, argv, "talker_ros_12");
  ros::NodeHandle n;
