...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionWpAction-request>)))
  ...
  (cl:format cl:nil "#constant for action~%uint8 ACTION_START  = 0~%uint8 ACTION_STOP   = 1~%uint8 ACTION_PAUSE  = 2~%uint8 ACTION_RESUME = 3~%~%#request~%uint8 action    # see constants for possible actions~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionWpAction-request)))
  "Returns full string definition for message of type 'MissionWpAction-request"
  (cl:format cl:nil "#constant for action~%uint8 ACTION_START  = 0~%uint8 ACTION_STOP   = 1~%uint8 ACTION_PAUSE  = 2~%uint8 ACTION_RESUME = 3~%~%#request~%uint8 action    # see constants for possible actions~%~%~%"))
