...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MissionHpGetInfo-response>)))
  ...
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%# for debugging usage~%uint8 cmd_set~%uint8 cmd_id~%uint32 ack_data~%~%================================================================================~%MSG: dji_sdk/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MissionHpGetInfo-response)))
  "Returns full string definition for message of type 'MissionHpGetInfo-response"
  (cl:format cl:nil "MissionHotpointTask hotpoint_task~%# for debugging usage~%uint8 cmd_set~%uint8 cmd_id~%uint32 ack_data~%~%================================================================================~%MSG: dji_sdk/MissionHotpointTask~%float64 latitude  # degree~%float64 longitude # degree~%float64 altitude  # meter~%float64 radius    # meter~%float32 angular_speed #deg/s~%uint8 is_clockwise~%uint8 start_point~%uint8 yaw_mode~%~%~%"))
