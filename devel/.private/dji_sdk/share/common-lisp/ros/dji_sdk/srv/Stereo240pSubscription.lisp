...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Stereo240pSubscription-request>)))
  ...
  (cl:format cl:nil "# assign value to 1 to subscribe~%uint8 front_right_240p~%uint8 front_left_240p~%uint8 down_front_240p~%uint8 down_back_240p~%~%# if unsubscribe_240p is 1,~%# service will unsubscribe no matter what~%uint8 unsubscribe_240p~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Stereo240pSubscription-request)))
  "Returns full string definition for message of type 'Stereo240pSubscription-request"
  (cl:format cl:nil "# assign value to 1 to subscribe~%uint8 front_right_240p~%uint8 front_left_240p~%uint8 down_front_240p~%uint8 down_back_240p~%~%# if unsubscribe_240p is 1,~%# service will unsubscribe no matter what~%uint8 unsubscribe_240p~%~%~%~%"))
